...
var Fields = exports.Fields = /*#__PURE__*/function (_base) {
  function Fields() {
    ...
    _this = _callSuper(this, Fields, ['fields', 'app', true, 'form']);
    _this._addProject();
    return _this;
  }
  ...
  return _createClass(Fields, [{
    ...
    value: function _handleAddProject(event) {
      event.preventDefault();
      var _this$_targetElementI = this._targetElementInputs(),
        _this$_targetElementI2 = _slicedToArray(_this$_targetElementI, 2),
        titleInput = _this$_targetElementI2[0],
        descInput = _this$_targetElementI2[1];
    ...
    key: "_targetElementInputs",
    value: function _targetElementInputs() {
    ...
    key: "_validateInputValues",
    value: function _validateInputValues(titleValue, descValue) {
      var _assignValidationInpu = (0, _validation_helpers.assignValidationInputs)(titleValue, descValue),
        _assignValidationInpu2 = _slicedToArray(_assignValidationInpu, 2),
        titleInputRule = _assignValidationInpu2[0],
